...
var _user$project$MainApp$main = {
	main: _elm_lang$html$Html$text('Start from here')
};

var Elm = {};
Elm['MainApp'] = Elm['MainApp'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MainApp'], 'MainApp', typeof _user$project$MainApp$main === 'undefined' ? null : _user$project$MainApp$main);
